#!/usr/bin/bash
#PBS -l select=1:ncpus=32:ngpus=0
...
python -u make_mordred.py | tee /home/ianlee/opt_ian/Model_Create_and_Results1/Pvk_additives/0_Create_Ground_Truth_Model/make_mordred.txt
conda deactivate
